function ShowMenu() {
  ...
  var logo_html = '<a href="/"><img id="tmd_logo" height="76" src="/pic/logo/'+logo+'" border="0" alt="Torrents.MD Logo" title="'+logo_main_title+'" '+logo_map+' style="border-style:none"></a>';
...
function _registred_menu()
{
  ...
  if(message.lang=='ro')
	  main_menu.innerHTML = '<table id="tbl_menu" cellSpacing="0" cellPadding="0" align="center"><tbody><tr><td align="left" id="menutable"><a href="/index.php">Pagina Principală</a>' + men_sep_img + '<a href="/browse.php">Torrente</a>' + men_sep_img + '<a href="/upload.php">Încarcă</a>' + men_sep_img + '<a href="/forum.php">FORUM</a>' + men_sep_img + '<a href="/topten.php">Top</a>' + men_sep_img + '<a href="/users.php">Utilizatori</a>' + men_sep_img + '<a href="/annou_jucarii.php">Împodobeşte-mă</a> '+ custom_html_to_menu + '</td><td align="right"><a href="/logout.php">Ieşire</a></td></tr></tbody></table>';
  else
	  main_menu.innerHTML = '<table id="tbl_menu" cellSpacing="0" cellPadding="0" align="center"><tbody><tr><td align="left" id="menutable"><a href="/index.php">Главная</a>' + men_sep_img + '<a href="/browse.php">Торренты</a>' + men_sep_img + '<a href="/upload.php">Загрузить</a>' + men_sep_img + '<a href="/forum.php">Форум</a>' + men_sep_img + '<a href="/topten.php">Топ</a>' + men_sep_img + '<a href="/users.php">Пользователи</a>' + men_sep_img + '<a href="/annou_jucarii.php">Разукрась меня</a>  '+ custom_html_to_menu + ' </td><td align="right"><a href="/logout.php">Выход</a></td></tr></tbody></table>';
}
