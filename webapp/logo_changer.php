...
function file_upload($upfile,$sufix='ro') {
		...
		if ($height != 76 && $height != 152) barkk('Logotipul Torrents.MD trebuie sa aiba exact 76 sau 152 pixeli in inaltime!');
...
if (isset($_POST['submit'])) {
	if (isset($_POST['predef_logo']) && $_POST['predef_logo'] == 1) {
      ...
      $_POST['logo_map_title'] = '';
		...
		to_adrenalin_email($log_message);
...
<input type="hidden" name="predef_logo">
	<table width="350px" cellspacing="0" cellpadding="5">
		<tr>
			<td><a href="/"><img src="/pic/logo/logo.png" alt="Torrents.MD Logo" height="76" width="280" border="0"></a></td>
		</tr>
	</table>
</div>
<div id="chlogo">
