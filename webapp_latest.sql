...
(0,1,'Categoria administratiei','Categoria administratiei','Categorie privatta unde discuta >=moderatorii','Categorie privatta unde discuta >=moderatorii',8,8,4,1,4,3098),
(1,2,'Library.MD','Library.MD','Evenimente, sugestii, buguri','Evenimente, sugestii, buguri',0,0,27,50,0,3202);
...
--
-- Table structure for table `posts_for_review`
--

DROP TABLE IF EXISTS `posts_for_review`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `posts_for_review` (
...
--
-- Table structure for table `releasers_groups`
--

DROP TABLE IF EXISTS `releasers_groups`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `releasers_groups` (
...
CREATE TABLE `searchindex` (
  ...
  `lang` tinyint(4) unsigned DEFAULT '0',
...
CREATE TABLE `torrents_details` (
  ...
  PRIMARY KEY (`id`),
  FULLTEXT KEY `descr_search_str` (`descr_search_str`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-03-01 18:42:47
